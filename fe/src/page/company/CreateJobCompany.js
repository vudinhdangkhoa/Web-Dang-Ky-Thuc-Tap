...
function CreateJobCompany() {
        ...
        if (validateForm()) {
            try {
                ...
                const response = await axiosInstance.post(
                    apiRoute.getUrl(`api/ChucNangDangTinTuyenDungCompany/CreateThongTinTuyenDung/${company.id}`),
                    jobData
                );
                ...
                setMessage({
                    type: 'danger',
                    message: 'Không thể tạo công việc. Vui lòng thử lại.'
                });
                setIsLoading(false);
            } 
    ...
    const checkIsLoading = () => {
        return isLoading || isLoadingCompany || isLoadingLocations;
    };
